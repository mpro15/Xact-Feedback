...
const TEST_USER = {
  email: `testuser${timestamp}@xactfeedback.com`,
...
async function createFreshTestLoginData() {
  console.log('🚀 Creating Fresh Test Company and User for Login Testing\n');
  ...
  try {
    ...
    if (profileError) {
      ...
      // Continue even if profile creation fails - basic auth might still work
    ...
    console.log('\n🎉 Fresh Test Login Data Creation Complete!\n');
